...
OPTIONAL_FILES=(org.thepriest.kali.svg kali-dragon.svg kali-watermark.svg)
...
EXT_FILES=(__init__.py extman.py foresight.py headroom.py memory.py mcp.py \
...
for _art in kali-watermark.svg kali-dragon.svg; do
